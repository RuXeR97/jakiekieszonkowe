                    ...
                    if (user.Password.Trim() == hashedPassword)
                    {
                        ...
                        foreach (var child in children)
                        {
                            userChildrenList.Add(new
                            {
                                ...
                                dateOfBirth = child.Date_of_birth.Value.ToString("YYYY-MM-DD"),
                                ...
                                prevPaymentDate = child.Date_of_payout.PreviousPaymentDate().Value.ToString("YYYY-MM-DD"),
                                nextPaymentDate = child.Date_of_payout.NextPaymentDate().Value.ToString("YYYY-MM-DD"),
                        ...
                        var finalResult = new
                        {
                            ...
                            userData = new                                     
                            {
                                ...
                                accountLastLogInDate =  user.Last_login_date.Value.ToString("YYYY-MM-DD"),
                ...
                using (JakieKieszonkoweEntities db = new JakieKieszonkoweEntities())
                {
                    ...
                    foreach (var singleChild in children)
                    {
                        userChildrenList.Add(new
                        {
                            ...
                            dateOfBirth = singleChild.Date_of_birth.Value.ToString("YYYY-MM-DD"),
                            ...
                            prevPaymentDate = singleChild.Date_of_payout.PreviousPaymentDate().Value.ToString("YYYY-MM-DD"),
                            nextPaymentDate = singleChild.Date_of_payout.NextPaymentDate().Value.ToString("YYYY-MM-DD"),
